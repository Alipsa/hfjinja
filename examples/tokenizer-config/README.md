...
Compile with Java 21 against a built hfjinja JAR:
    ...
    javac --release 21 --module-path ../../build/libs --add-modules se.alipsa.hfjinja TokenizerConfigExample.java
    java --module-path ../../build/libs --add-modules se.alipsa.hfjinja -cp . example.TokenizerConfigExample
